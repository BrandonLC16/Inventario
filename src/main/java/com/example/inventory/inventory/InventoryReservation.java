...
class InventoryReservation {
    ...
    @Column(name = "reserved_by", nullable = false, length = 255) private String reservedBy;

    protected InventoryReservation() { }

    InventoryReservation(UUID orderId, UUID warehouseId, UUID productId,
                         int quantity, String reservedBy) {
